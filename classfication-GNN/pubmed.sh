...
python3 multiclass.py --dataset pubmed_semi   --agp_alg appnp_agp --alpha 0.1 --rmax 1e-7 --L 20 --lr 0.0001 --dropout 0.3 --hidden 2048   --batch 512  --layer 1 --epochs 200 --patience 200 --rep_num 1 |& tee ./logs/pubmed_semi_2048_512_200_200_1.log
